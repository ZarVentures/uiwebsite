    ...
    <section id="contact" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        <div className="flex flex-col items-center text-center group premium-hover">
          ...
          <a href={`mailto:${content?.email || ""}`} className="text-muted-foreground hover:text-primary transition-colors duration-300 font-light">
            {content?.email || ""}
          </a>
        </div>
        <div className="flex flex-col items-center text-center group premium-hover">
          ...
          <a href={`tel:${content?.phone || ""}`} className="text-muted-foreground hover:text-primary transition-colors duration-300 font-light">
            {content?.phone || ""}
          </a>
        </div>
        <div className="flex flex-col items-center text-center group premium-hover">
      ...
      {/* Contact Form */}
      <form className="max-w-2xl mx-auto bg-white luxury-shadow rounded-2xl p-10 elegant-border">
